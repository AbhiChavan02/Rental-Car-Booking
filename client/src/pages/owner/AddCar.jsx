...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
        ...
        booking, including pricing, availablility, and car specifications'/>
        ...
        text-sm mt-6 max-w-xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className='flex flex-col w-full'>
                    <label>Brand</label>
                    <input type='text' placeholder='e.g. BMW, Mercedes, Audo...' required
            ...
            <div className='flex flex-col w-full'>
                    ...
                    <textarea rows={5} placeholder='e.g. A luxurious SUV with a specious interior and a powerful engine.' 
                    required className='px-3 py-2 mt-1 border border-borderColor 
                    rounded-md outline-none' value={car.description} 
